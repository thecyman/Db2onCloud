...
* [International Db2 Users Group (IDUG®)](https://www.idug.org/){:external} Join thousands of professionals using Db2 with IDUG®, an independent, not-for-profit, user-run organization for Db2 users. The IDUG online forums are a great place to ask for help or get involved. IDUG events around the world let you connect and learn with other Db2 professionals.
