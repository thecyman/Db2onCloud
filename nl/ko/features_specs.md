...
| 데이터 센터 위치 옵션 |Y | [위치](https://ibm.biz/db2oncloud-locations){:external}. 배치 & 스케일링 기간도 참조하십시오. |
| BLU 인메모리 |Y | 기본값은 행입니다. BLU에 대해 `CREATE TABLE..AS COL`을 지정하십시오. |
| 활동 트래커 | [로드맵 내](https://ibm.biz/db2oncloud-roadmap){:external} | - |
| 루트 액세스 제공 | N | 루트 액세스가 필요한 경우 Db2 Hosted 사용 |
{: class="simple-tab-table"}
{: caption="표 1. 일반" caption-side="top"}
{: #simpletabtable1}
{: tab-title="General"}
{: tab-group="fs"}
...
| 동일한 데이터 센터의 다른 구역 | [로드맵 내](https://ibm.biz/db2oncloud-roadmap){:external} | **참고**: 오프사이트 HADR을 사용할 수 있음 |
| Change Data Capture(CDC) |Y | - |
| 온프레미스에서 HADR로 사용 | N | CDC를 사용하십시오. 자세한 정보는 [Db2에서 Db2 on Cloud로 어떻게 데이터를 마이그레이션하거나 동기화할 수 있습니까?](https://developer.ibm.com/answers/questions/426111/how-can-i-migrate-from-db2-to-db2-on-cloud/){:external}를 참조하십시오. |
| 자율 장애 복구 - HA |Y | - |
...
{: class="simple-tab-table"}
{: caption="표 2. 고가용성 및 복제" caption-side="top"}
{: #simpletabtable2}
...
| 기능 | 지원 여부? | 설명 |
|---------|------------|----------|
| 최대 RAM 및 코어 수 | 1TB RAM, 48개의 코어 | Precise Performance XL 플랜에 적용 |
...
{: class="simple-tab-table"}
{: caption="표 3. 시스템 구성" caption-side="top"}
{: #simpletabtable3}
...
|유지보수 정책 |Y | [세부사항 읽기](https://developer.ibm.com/answers/questions/439146/where-can-i-find-detail-about-maintenance-and-noti.html){:external} |
{: class="simple-tab-table"}
{: caption="표 4. 유지보수 정책 및 SLA" caption-side="top"}
{: #simpletabtable4}
...
| 기능 | 지원 여부? | 설명 |
|---------|------------|----------|
| HIPAA 준비 |Y | Flex 등의 모든 유료 플랜. IBM 지원 센터에서 HIPAA 모드를 요청해야 합니다. |
| HITRUST  | [로드맵 내](https://ibm.biz/db2oncloud-roadmap){:external} | 이제 HITRUST에 Db2 Hosted를 사용할 수 있음 |
...
| 전체 준수 목록 |Y | [보안 준수](https://www.ibm.com/support/knowledgecenter/en/SSFMBX/com.ibm.swg.im.dashdb.security.doc/doc/compliances.html){:external} |
{: class="simple-tab-table"}
{: caption="표 5. 보안 준수" caption-side="top"}
{: #simpletabtable5}
...
| 복원 없이 이전 데이터 조회 |Y | [Time Travel Query](https://developer.ibm.com/answers/questions/426878/how-do-i-use-time-travel-query-in-db2-or-db2-on-cl.html){:external}를 설정해야 합니다. |
{: class="simple-tab-table"}
{: caption="표 6. 백업 및 복원" caption-side="top"}
{: #simpletabtable6}
...
| 기능 | 지원 여부? | 설명 |
|---------|------------|----------|
| 싱글 테넌트 가상 머신 |Y | Flex 등의 모든 유료 플랜은 싱글 테넌트 VM 또는 베어메탈입니다. |
...
| 키 보호(고유 키 가져오기) | [로드맵 내](https://ibm.biz/db2oncloud-roadmap){:external} | - |
| MIS/상호연결된 서비스 | [로드맵 내](https://ibm.biz/db2oncloud-roadmap){:external} | - |
| 최대 동시 연결 한계: **무료 플랜** |Y | 최대: 5개의 연결  |
| 최대 동시 연결 한계: **유료 플랜** | N | 무제한 연결  |
{: class="simple-tab-table"}
{: caption="표 7. 네트워킹, 보안 및 VM" caption-side="top"}
{: #simpletabtable7}
...
| 기능 | 지원 여부? | 설명 |
|---------|------------|----------|
| BYOL 할인 |Y | [공지사항](https://ibm.biz/db2oncloud-byol){:external} |
| IBM Cloud에서 사용 가능 |Y | 구독 및 종량과금제 모두 |
| 소프트웨어 견적 주문을 통해 사용 가능 |Y | Flex 등의 모든 플랜. [파트 & 세부사항](https://ibm.biz/db2oncloud-parts-public){:external}|
|HDMP(Hybrid Data Management Platform)에서 사용 가능 |Y | Flex 플랜만 해당합니다. [HDMP에 대한 세부사항](https://www.ibm.com/ca-en/marketplace/hybrid-data-management-platform){:external}|
...
| 시간별 비용 청구 | [로드맵 내](https://ibm.biz/db2oncloud-roadmap){:external} | - | 
...
{: class="simple-tab-table"}
{: caption="표 8. 가격 및 구매" caption-side="top"}
{: #simpletabtable8}
...
| 기능 | 지원 여부? | 설명 |
|---------|------------|----------|
| 댈러스 | **배치**: < 5분. **스케일**: < 45분. | Flex 플랜만 해당, 재고에 따라 다름 |
...
{: class="simple-tab-table"}
{: caption="표 9. 배치 및 스케일링 기간" caption-side="top"}
{: #simpletabtable9}
