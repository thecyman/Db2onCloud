...
# Sobre o DB2 on Cloud
{: #overview}

O {{site.data.keyword.Db2_on_Cloud_long}} é um serviço de banco de dados SQL totalmente gerenciado. O
console da web do {{site.data.keyword.Db2_on_Cloud_short}} facilita as tarefas comuns, como a importação de planilhas,
a execução de instruções SQL e o monitoramento do seu serviço.
{: shortdesc}

## O que está incluído no serviço gerenciado?
{: #managed_service}
