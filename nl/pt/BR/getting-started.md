...
Também é possível instalar um banco de dados DB2 local usando o [download grátis do DB2 Developer Edition](https://www.ibm.com/us-en/marketplace/ibm-db2-direct-and-developer-editions){:external}. Ele instala rapidamente uma
...
Para instalar pacotes de drivers Python para o MacOS, deve-se usar o comando `pip` com a opção `--no-cache-dir`. Para obter instruções detalhadas, veja:
[Suporte do Python para o IBM DB2 e IBM Informix](https://ibm.biz/db2-drivers-python){:external}
{: note}

Se você estiver fazendo um trabalho de ciência de dados com o Python ou desejar suporte para quadros de dados, análise dentro do banco de dados ou usar o Watson Studio, pode desejar usar o
driver alternativo a seguir, que se concentra no suporte a uma variedade de funções de ciência de
dados: [ibmdbpy 0.1.5](https://pypi.org/project/ibmdbpy/){:external}.
{: note}
...
- [Drivers Python](https://ibm.biz/db2-drivers-python){:external}
- [Drivers Node.js](https://ibm.biz/db2-drivers-node){:external}
...
1. [Instale o pacote de drivers](https://www.ibm.com/support/knowledgecenter/SSFMBX/com.ibm.swg.im.dashdb.doc/connecting/connect_driver_package_install.html){:external} no computador no qual seus apps ou ferramentas estão
em execução.
2. [Configure os arquivos de driver](https://www.ibm.com/support/knowledgecenter/en/SSFMBX/com.ibm.swg.im.dashdb.doc/connecting/connect_driver_package_config.html){:external} para seu banco de dados do {{site.data.keyword.Db2_on_Cloud_short}}.
