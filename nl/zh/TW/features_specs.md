...
|  | 相同資料中心的不同區域 | [在導覽圖中 ![外部鏈結圖示](../../icons/launch-glyph.svg "外部鏈結圖示")](https://ibm.biz/db2oncloud-roadmap){:new_window} | - |
|  | 變更資料擷取 (CDC) | 是 | - |
...
|  | KeyProtect（自帶金鑰） | [在導覽圖中 ![外部鏈結圖示](../../icons/launch-glyph.svg "外部鏈結圖示")](https://ibm.biz/db2oncloud-roadmap){:new_window} | - |
