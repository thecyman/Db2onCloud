...
If you're deploying the free Lite plan outside of continental America, you may need to read [Using the Lite plan outside continental North America](https://console.bluemix.net/docs/services/Db2onCloud/free_plan.html#free_plan)
{: shortdesc}
