...
To be able to use the new features such as [IBM Key Protect](/docs/services/Db2onCloud?topic=Db2onCloud-key-protect) and Copy Database, you must migrate your Cloud Foundry service instances to RC.
{: important}
