...
Db2 data virtualization (also known as federation) is supported by Db2 on Cloud. Data virtualization gives you single-query access to all of your data located on multiple distributed databases anywhere in your organization. You can access data that is located on any of your Db2 or Informix data sources, both in the cloud and on premises. 
{: shortdesc}

This functionality is supported on all versions of Db2 on Cloud, except for the free Lite plan. However, you can use the Lite plan as a target from which you can pull data.
...
The following steps are an example of how you go about federating your disparate data sources to appear as if the data is retrieved from a single source. The following example illustrates the federation of two Db2 on Cloud databases:
